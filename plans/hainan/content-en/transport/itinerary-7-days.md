...
```mermaid
flowchart LR
    A["Changsha to Haikou"] --> B["Collect car"]
    B --> C["Wenchang or Boao"]
    C --> D["Two nights in Wanning"]
    D --> E["Optional local motorcycle day"]
    D --> F["Lingshui and Haitang Bay"]
    F --> G["Wuzhizhou and Sanya"]
    G --> H["Return car and fly home"]
```
...
![Haikou Qilou Old Street](../../assets/images/haikou-qilou-old-street-2022.jpg)

![Haikou Century Bridge at night](../../assets/images/haikou-century-bridge-2023.jpg)
...
![Wanning tropical streets](../../assets/images/wanning-hainan-cc0.jpg)
...
![Wuzhizhou Island](../../assets/images/wuzhizhou-island-cc0.jpg)
